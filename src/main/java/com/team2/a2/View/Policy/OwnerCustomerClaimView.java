...
public class OwnerCustomerClaimView implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        createClaimButton.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/PolicyOwnerCreateClaim.fxml"));
                Parent root = loader.load();

                OwnerCreateClaimView policyOwnerCreateClaimView = loader.getController();
