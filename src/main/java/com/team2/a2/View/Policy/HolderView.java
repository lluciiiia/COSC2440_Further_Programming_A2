...
public class HolderView implements Initializable, BaseView {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        viewInfoButton.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/PolicyHolderInformationPage.fxml"));
                Parent root = loader.load();
                HolderInformationView policyHolderInformationView = loader.getController();
        ...
        viewDependentInformationButton.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/PolicyHolderDependentPage.fxml"));
                Parent root = loader.load();
                HolderDependentView policyHolderDependentPage = loader.getController();
        ...
        viewClaimInformationButton.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/PolicyHolderClaimPage.fxml"));
                Parent root = loader.load();
                HolderClaimView policyHolderClaimView = loader.getController();
        ...
        createClaim.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/PolicyHolderCreateClaimPage.fxml"));
                Parent root = loader.load();
                HolderCreateClaimView policyHolderCreateClaimView = loader.getController();
