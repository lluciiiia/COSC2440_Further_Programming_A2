...
public class OwnerCustomersView implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        returnButton.setOnAction(event -> {
            try {
                ...
                OwnerView policyOwnerView = loader.getController();
        ...
        viewCustomerClaimButton.setOnAction(event -> {
            try {
                ...
                Parent root = loader.load();
                OwnerCustomerClaimView policyOwnerCustomerClaimView = loader.getController();
...
//            try {
//                Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/team2/a2/PolicyOwnerCustomerCardPage.fxml")));
//                Scene scene = new Scene(root);
