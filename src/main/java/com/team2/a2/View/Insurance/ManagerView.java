...
public class ManagerView implements Initializable, BaseView {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ViewMyButton.setOnAction(event -> {
            try {
                ...
                ManagerInforView insuranceManagerInforView = loader.getController();
        ...
        ViewCustomerButton.setOnAction(event -> {
            try {
                ...
                Parent root = loader.load();
                ManagerAllCustomerView insuranceManagerAllCustomerView = loader.getController();
        ...
        ViewInsuranceSurveyorButton.setOnAction(event -> {
            try {
                ...
                Parent root = loader.load();
                ManagerSurveyorView insuranceManagerSurveyorView = loader.getController();
        ...
        ViewLOCButton.setOnAction(event -> {
            try {
                ...
                Parent root = loader.load();
                ManagerLOCView insuranceManagerLOCView = loader.getController();
