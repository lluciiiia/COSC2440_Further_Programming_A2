...
public class PolicyOwnerView implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        CreatePolicyOwnerAccount.setOnAction(event -> {
            try {
                Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/team2/a2/AdminCreatePolicyOwnerAccountPage.fxml")));
                Scene scene = new Scene(root);
        ...
        ViewAllPolicyOwnerButton.setOnAction(event -> {
            try {
                ...
                AllPolicyOwnerView adminAllPolicyOwnerView = loader.getController();
