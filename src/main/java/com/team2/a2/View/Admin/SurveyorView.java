...
public class SurveyorView implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        CreateSurveyorButton.setOnAction(event -> {
            try {
                Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/team2/a2/AdminCreateSurveyorPage.fxml")));
                Scene scene = new Scene(root);
        ...
        ViewAllSurveyorButton.setOnAction(event -> {
            try {
                ...
                AllSurveyorView adminAllSurveyorView = loader.getController();
