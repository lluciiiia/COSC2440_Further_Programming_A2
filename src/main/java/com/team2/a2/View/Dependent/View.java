...
public class View implements Initializable, BaseView {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        viewInfoButton.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/DependentInformationPage.fxml"));
                Parent root = loader.load();
                InformationView dependentInformationView = loader.getController();
        ...
        viewClaim.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/DependentClaimPage.fxml"));
                Parent root = loader.load();
                ClaimView dependentClaimView = loader.getController();
        ...
        viewInsuranceCard.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/DependentInsuranceCardPage.fxml"));
                Parent root = loader.load();
                InsuranceCardView dependentInsuranceCardView = loader.getController();
