package com.team2.a2.View.Login;
        ...
        if (account != null) {
            ...
            switch (account.getType()) {
                ...
                case INSURANCE_MANAGER:
                    ...
                    root = loader.load();
                    BaseView insuranceManagerView = loader.getController();
                ...
                case INSURANCE_SURVEYOR:
                    ...
                    root = loader.load();
                    BaseView insuranceSurveyorView = loader.getController();
