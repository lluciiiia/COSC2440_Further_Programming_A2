...
public class PolicyHolderView implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        viewInsuranceButton.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/PolicyHolderInsuranceCardPage.fxml"));
                Parent root = loader.load();
        ...
        viewLogHistoryButton.setOnAction(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/team2/a2/PolicyHolderViewLogHistoryPage.fxml"));
                Parent root = loader.load();
