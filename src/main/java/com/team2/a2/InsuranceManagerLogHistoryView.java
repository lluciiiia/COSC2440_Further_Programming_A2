...
public class InsuranceManagerLogHistoryView implements Initializable {
    @FXML
...
//    private TableColumn<History, String> logHistoryColum;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        returnButton.setOnAction(event -> {
            try {
                Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("InsuranceManagerPage.fxml")));
