...
public class InsuranceSurveyorInfoView implements Initializable {
    ...
    public void initData(InsuranceSurveyor insuranceSurveyor) {
        name.setText(insuranceSurveyor.getName());
        companyName.setText(insuranceSurveyor.getCompanyName());
        phone.setText(insuranceSurveyor.getPhoneNumber());
        email.setText(insuranceSurveyor.getEmail());
        companyAddress.setText(insuranceSurveyor.getCompanyAddress());
