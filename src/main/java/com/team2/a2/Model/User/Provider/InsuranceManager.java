...
public class InsuranceManager extends Provider{
    ...
    public InsuranceManager(int id, Date createdAt, Date updatedAt, int accountId, String companyName, String companyAddress, String providerPhone, String providerEmail, String providerID, String providerName, AccountType type, List<InsuranceSurveyor> insuranceSurveyors) {
